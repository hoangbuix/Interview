...
const userReducer = (state = inintialState, action: { type: any, payload: any }) => {
    switch (action.type) {
        ...
        case types.LOGIN_SUCCESS:
            return { ...state, isFetching: false, user: action.payload, isAuthenticated: true };
        ...
        case types.GET_USER_ALL_SUCCESS:
            return { ...state, isFetching: false, users: action.payload.data.users, isAuthenticated: true };
